...
![The study area with the national boundaries, main roads, rivers and urban areas and shaded relief. Source: [Natural Earth](https://www.naturalearthdata.com/).](images/aoi.png){#fig-baselayers}

For an effective workflow, it is a good idea to organize your data well. For this tutorial, we'll keep the base layers in the [PERMANENT]{.style-db} mapset. For input data for our modeling and the modeling results, we'll use separate mapsets.
