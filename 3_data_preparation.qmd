...
In the menu, go to [Settings → GRASS working environment → Mapset access]{.style-menu} and select the mapsets [climate_current]{.style-db} and [Erebia_alberganus]{.style-db}.
:::
