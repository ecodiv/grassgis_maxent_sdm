...
Earlier, we selected several environmental variables as predictors of the suitability of a location for our species. However, often, the relationship between these variables and the occurrence of our species will be more complex. For example, the species may not like low temperatures but also dislike high temperatures. Maxent allows you to incorporate these more complex relationship forms into the model by transforming the explanatory variables using various functions, called features. Below you find a basic explanation about these features. For a more comprehensive explanation, see @merowPracticalGuideMaxEnt2013 and @phillipsModelingSpeciesDistributions2008.
