...
![A) The developing of a species distribution model. B) Usig the model to predict the potential distribution of a species under future climate conditions. Step B is the focus of this chapter.](images/Flowchart_model_predict2.png){#fig-Flowchart_model_predict2 width="450" fig-align="left"}
